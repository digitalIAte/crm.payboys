export default function Login() {
    return (
        <div className="min-h-screen flex bg-[#0a0a0a] text-white font-sans selection:bg-payboys selection:text-black">
            {/* Centered Login Form */}
            <div className="w-full flex items-center justify-center p-8 relative overflow-hidden">

                {/* Background ambient glow */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-payboys/10 blur-[120px] rounded-full pointer-events-none" />
