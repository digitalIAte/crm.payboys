    ...
    return (
        <div className="space-y-8 max-w-6xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                ...
                <Link href="/crm/leads" className="bg-payboys text-black px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-payboys-dark shadow-sm transition-colors">
                    View All Leads
                </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#111111] rounded-xl shadow-sm border border-gray-800 p-6 flex items-center justify-between transition-transform hover:-translate-y-1 hover:shadow-md">
                    <div>
                        <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">Total Leads</p>
                        <h3 className="text-4xl font-extrabold text-white">{totalLeads}</h3>
                    </div>
                    <div className="p-4 bg-payboys/10 rounded-full">
                        <svg className="w-8 h-8 text-payboys" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    </div>
                </div>
                ...
                <div className="bg-[#111111] rounded-xl shadow-sm border border-gray-800 p-6 flex items-center justify-between transition-transform hover:-translate-y-1 hover:shadow-md">
                    <div>
                        ...
                        <h3 className="text-4xl font-extrabold text-payboys">{avgScore}</h3>
                    </div>
                    <div className="p-4 bg-payboys/10 rounded-full">
            ...
            {/* Recent Leads Table */}
            <div className="bg-[#111111] shadow-sm rounded-xl border border-gray-800 overflow-hidden">
                                ...
                                <tr key={lead.id} className="hover:bg-white/5 transition-colors">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            <div className="h-9 w-9 rounded-full bg-gradient-to-br from-payboys/20 to-payboys/30 flex items-center justify-center text-payboys font-bold shadow-inner">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full border 
                                            ${lead.status === 'qualified' ? 'bg-emerald-900/30 text-emerald-400 border-emerald-800' :
                                                lead.status === 'lost' ? 'bg-red-900/30 text-red-400 border-red-800' :
                                                    'bg-payboys/20 text-payboys border-payboys/30'}`}>
                                            {lead.status}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                                        <Link href={`/crm/leads/${lead.id}`} className="text-payboys font-medium hover:text-payboys-light bg-payboys/10 px-3 py-1.5 rounded-md hover:bg-payboys/20 transition-colors">
                                            View
                                        </Link>
                                    </td>
                                </tr>
